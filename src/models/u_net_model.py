...
class UNet(BaseModel):
    ...
    def __init__(self, config,path,batch_size):
    ...
    def load_data(self):
        ...
        LOG.info(f'Loading {self.path} dataset...')
    ...
    def build(self):
        ...
        # This is the last layer of the models
    ...
    def train(self):
        """Compiles and trains the models"""
